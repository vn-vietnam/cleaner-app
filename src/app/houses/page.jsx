...
function Workers() {
	...
	const filterHouse = bussinessList?.filter((e, index) => {
		return e.name.toLocaleLowerCase().includes(textSearch);
	});
	...
	return (
		<div className="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8 py-10">
			<div className="flex justify-between w-full flex-col">
				<h2 className="font-bold text-[22px]">Find House</h2>
				<div className="relative">
					<Search className="absolute top-2 left-2" />
					<Input
						className="w-[100%] sm:w-[30%] lg:w-[20%] pl-8"
    ...
    lg:grid-cols-4 gap-6 mt-5 "
			>
				{textSearch !== ""
					? filterHouse.map((business, index) => (
							<Link
